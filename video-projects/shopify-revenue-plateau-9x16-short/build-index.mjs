...
const ID = "shopify-revenue-plateau-9x16-short";
const FACE_DUR = 18.25;                      // stitched VO length
const COMP     = process.env.TEST ? 6 : 19.0;
const CAP_PAD  = 380;   // taller caption/UI safe zone for 9:16
...
<html lang="en">
  <head>
    ...
    <style>
      ...
      * { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      #video-wrap video { width: 100%; height: 100%; object-fit: cover; object-position: 50% 50%;
  ...
  <body>
    <div id="root" data-composition-id="${ID}" data-start="0" data-duration="${COMP}" data-width="1080" data-height="1920">
