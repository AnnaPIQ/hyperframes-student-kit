...
## Spec
- **Format:** 1080×1920, 30 fps, 22.0 s (660 frames)
...
| C | CTA  | 41.18–48.75 | 13.33–20.93 | "It's things like this that we cover inside our completely free profitability bootcamp. Click the link below to apply for access." |
...
land in silence with 8 ms edge fades. **C runs through the full final word "access"**
(48.46) plus a beat; the end card then holds over navy from 16.9→22.0 s so the CTA line
never clips and the outro breathes (~1.4 s settle after the VO ends).
...
- **End card (last 5.1 s, 16.9→22.0):** navy canvas + blue bloom, white logo, "READY TO
