...
| **26.23–45.17** | "I've put together a free workbook… It's completely free." | **B-roll: `workbook-broll.mp4`** | **WORKBOOK B-ROLL.** EcomIQ's own 30s workbook piece, re-rendered from source with its perspective floor grid and corner crosshairs off, carries the whole stretch, replacing the four graphic scenes that were built here (cover, max-discount dial, checklist, FREE). It plays full-width in the navy field, edges feathered. Two trims of one source, one cut, at 31.00: |
