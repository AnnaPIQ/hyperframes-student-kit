...
EDITS = [
    ...
    ("#g-days .word { font-weight: 800; font-size: 96px; line-height: 1;",
     "#g-days .word { font-weight: 800; font-size: 78px; line-height: 1;", 1),

    ("#g-flow { bottom: 360px;", "#g-flow { bottom: 238px;", 1),
    ("#g-flow .tag { font-size: 58px;", "#g-flow .tag { font-size: 50px;", 1),

    # ---- end card -----------------------------------------------------------
    ("justify-content: center; gap: 52px; }", "justify-content: center; gap: 40px; }", 1),
    ...
    ("font-style: italic; font-weight: 400; font-size: 88px; line-height: 1;",
     "font-style: italic; font-weight: 400; font-size: 74px; line-height: 1;", 1),
