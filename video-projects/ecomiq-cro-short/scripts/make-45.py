...
EDITS = [
    ...
    # ---- end card -----------------------------------------------------------
    ("justify-content: center; gap: 96px; }", "justify-content: center; gap: 72px; }", 1),
    ("#card-logo { position: relative; width: 520px;",
     "#card-logo { position: relative; width: 450px;", 1),
    ("#card-headline { position: relative; text-align: center; max-width: 800px; }",
     "#card-headline { position: relative; text-align: center; max-width: 690px; }", 1),
    ("#card-headline .line { font-size: 66px; font-weight: 800; line-height: 1.06;",
     "#card-headline .line { font-size: 56px; font-weight: 800; line-height: 1.06;", 1),
    ("#card-headline .em { font-size: 92px; font-weight: 800; line-height: 1;",
     "#card-headline .em { font-size: 78px; font-weight: 800; line-height: 1;", 1),
    ("letter-spacing: -.02em; color: var(--brand-white); margin-top: 96px; }",
     "letter-spacing: -.02em; color: var(--brand-white); margin-top: 72px; }", 1),
